...
# From micropython-lib (MIT): https://github.com/micropython/micropython-lib/tree/master/micropython/umqtt.simple
# Vendored unchanged.
#
# ESP32 firmware already has this frozen in, so importing umqtt.simple works there with nothing
# installed. A Pico W does not, which is why it is here: installing this driver makes the same
# code run on both.
import socket
import struct
